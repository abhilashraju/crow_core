  ...
  public:
    ...
    FindRouteResponse findRoute(Request& req) const
    {
             ...
             perMethodIndex++)
        {
            ...
            FindRoute route = findRouteByIndex(req.url().encoded_path(), perMethodIndex);
                       ...
                       Adaptor&& adaptor)
    {
        ...
        const std::pair<unsigned, RoutingParams>& found = trie.find(req.url().encoded_path());
                ...
                bool bypassAuth = false)
    {
        ...
        if (foundRoute.route.rule == nullptr)
        {
            ...
            {
                foundRoute.route = findRouteByIndex(req.url().encoded_path(), notFoundIndex);
            }
            else
            {

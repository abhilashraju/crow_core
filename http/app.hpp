...
// #endif
// template <typename Router> class App {
// public:
// #ifdef BMCWEB_ENABLE_SSL
//   using ssl_socket_t =
//   boost::beast::ssl_stream<boost::asio::ip::tcp::socket>; using ssl_server_t
//   = Server<App, ssl_socket_t>;
// #else
...
//     if (-1 == socketFd) {
//       server =
//           std::make_unique<server_t>(this, bindaddrStr, portUint, nullptr,
//           io);
//     } else {
